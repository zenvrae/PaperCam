...
import { Bookmark, Lightbulb, Pin, Trash2, CheckCircle2, BookmarkX } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-3">
          <BookmarkX className="w-12 h-12 text-slate-300 mx-auto" />
          <h3 className="text-lg font-bold text-slate-800">No Bookmarked Questions Yet</h3>
          <p className="text-xs text-slate-500 max-w-sm mx-auto">
            While taking practice tests, bookmark important questions to revise them here.
          </p>
        </div>
      ) : (
